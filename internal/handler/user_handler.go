...
func (h *UserHandler) RegisterRoutes(router *mux.Router) {
	...
	router.HandleFunc("/users/{id}/credit", h.GetCreditByID).Methods(http.MethodGet)

	// Delete
	router.HandleFunc("/users/{id}", h.DeleteUser).Methods(http.MethodDelete)

	// Credit Operations
	router.HandleFunc("/users/{id}/credit/add", h.AddCredit).Methods(http.MethodPost)
	router.HandleFunc("/users/{id}/credit/deduct", h.DeductCredit).Methods(http.MethodPost)
	router.HandleFunc("/users/{id}/credit/transfer", h.Transfer).Methods(http.MethodPost)
